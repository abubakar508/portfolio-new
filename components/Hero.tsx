...
const Hero = () => {
  return (
    ...
    <div className=" md:h-screen flex items-center justify-center relative">
      <div className=" flex flex-col md:flex-row md:gap-7 justify-between items-center w-full px-64">
        {/* image section */}
      ...
      {/* socials */}
      <div className=" absolute h-screen left-3 flex items-center flex-col justify-center">
